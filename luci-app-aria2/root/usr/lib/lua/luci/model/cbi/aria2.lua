...
button = "&nbsp;/&nbsp;<input type='button' value='Webui' onclick='window.open(\"http://\"+window.location.host+\"/aria2\")'/>&nbsp;&nbsp;<input type='button' value='YAAW' onclick='window.open(\"http://\"+window.location.host+\"/yaaw\")'/>"
if running then
	m = Map("aria2", translate("Aria2 Settings"), translate("Aria2 is running") .. button)
else
	m = Map("aria2", translate("Aria2 Settings"), translate("Aria2 is not running"))
end
