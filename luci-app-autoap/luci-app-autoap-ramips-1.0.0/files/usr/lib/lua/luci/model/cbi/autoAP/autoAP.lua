...
local dev = uci:get("autoAP", "once", "staRadio")
...
-- AP Radio device
apRadio = once:option(ListValue, "apRadio", translate("AP Radio device"), translate("The radio device which AP use"))
uci:foreach("wireless", "wifi-device",
			   function(s)
				  apRadio:value(s['.name'])
			   end)
apRadio = once:option(DummyValue, "", translate("\n"))


-- Station Radio device
staRadio = once:option(ListValue, "staRadio", translate("STATION Radio device"), translate("The radio device which STATION use"))
uci:foreach("wireless", "wifi-device",
			   function(s)
				  staRadio:value(s['.name'])
			   end)
staRadio = once:option(DummyValue, "", translate("\n"))
...
-- *********** relay ***********
s = m:section(TypedSection, "relay", translate("relay stations"), translate("Now maximum support 32 stations"))
s.addremove = true
s.anonymous = false
o = s:option(DummyValue, "", translate("\n"))
...
-- ssid
o = s:option( Value, "ssid", translate("STATION SSID"))
--[[
